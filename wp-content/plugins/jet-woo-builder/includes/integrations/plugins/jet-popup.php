...
if ( ! class_exists( 'Jet_Woo_Builder_Popup_Package' ) ) {
	...
	class Jet_Woo_Builder_Popup_Package {
		...
		public function __construct() {
			...
			add_filter( 'jet-woo-builder/templates/jet-woo-products/widget-attributes', [ $this, 'get_cart_popup_data_attrs' ], 10, 2 );
			add_filter( 'jet-woo-builder/templates/jet-woo-products-list/widget-attributes', [ $this, 'get_cart_popup_data_attrs' ], 10, 2 );
			add_filter( 'jet-woo-builder/jet-woo-archive-add-to-cart/widget-attributes', [ $this, 'get_cart_popup_data_attrs' ], 10, 2 );
			add_filter( 'jet-woo-builder/jet-single-add-to-cart/widget-attributes', [ $this, 'get_cart_popup_data_attrs' ], 10, 2 );
		...
		public function register_controls( $manager ) {
			...
			$manager->add_control(
				...
				array(
					'label'       => esc_html__( 'Cart Popup', 'jet-woo-builder' ),
					'label_block' => true,
					'type'        => 'jet-query',
					'query_type'  => 'post',
		 ...
		 * @return string
		 */
		public function get_cart_popup_data_attrs( $attributes, $settings ) {
			...
			$attributes .= sprintf( ' data-cart-popup-enable=%s data-cart-popup-id=%s ', json_encode( $popup_enable ), $popup_id );
